...
const validateKey = (key) => {
    ...
    if (!VALID_KEY_NAME.test(key)) {
        throw new InvalidArgumentError('Key names must start with a letter and can only consist of alphanumeric characters and underscores');
    }
...
export const parseDeployEnvVar = (flag) => (arg, previous = []) => {
 ...
 * expects.
 */
export const mergeDeployEnvVars = (env = [], secretEnv = []) => [...env, ...secretEnv];
/**
 ...
 */
export const findDuplicateKey = (variables) => {
    const seen = new Set();
...
//# sourceMappingURL=deploy-env-vars.js.map