...
const hashBundle = async (filepath, hashAlgorithm) => {
...
const hashEdgeFunctions = async (edgeFunctionsDistPath, { hashAlgorithm = 'sha256', statusCb }) => {
    const edgeFunctions = {};
    const edgeFnShaMap = {};
    ...
    let manifest;
    try {
        manifest = JSON.parse(await readFile(join(edgeFunctionsDistPath, 'manifest.json'), 'utf8'));
    }
    catch {
...
//# sourceMappingURL=hash-edge-functions.js.map