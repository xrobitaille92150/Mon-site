...
export const resolveTeam = (accounts) => {
    if (accounts.length === 1) {
        return accounts[0];
    }
    return accounts.find((acc) => acc.default);
};
export const resolveTeamForNonInteractive = (accounts, commandExample) => {
    ...
    return logAndThrowError(`Multiple teams available. Please specify which team to use.\n` +
