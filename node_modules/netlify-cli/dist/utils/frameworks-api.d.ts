 ...
 */
export declare const getFrameworksAPIPaths: (basePath: string, packagePath?: string) => Record<"blobs" | "config" | "edgeFunctions" | "edgeFunctionsImportMap" | "functions" | "root", FrameworksAPIPath>;
/**
