...
const toStatementResults = (result) => Array.isArray(result) ? result : [result];
export const formatStatementResults = (result) => toStatementResults(result)
...
export const lastRowSet = (result) => toStatementResults(result).findLast(({ fields }) => fields.length > 0)?.rows ?? [];
