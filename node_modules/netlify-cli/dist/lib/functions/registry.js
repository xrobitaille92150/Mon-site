...
export class FunctionsRegistry {
    ...
    timeouts;
    deployEnvironment;
    constructor({ aiGatewayContext, blobsContext, capabilities, config, debug = false, deployEnvironment, frameworksAPIPaths, generatedFunctions, isConnected = false, logLambdaCompat, manifest, projectRoot, settings, timeouts, }) {
