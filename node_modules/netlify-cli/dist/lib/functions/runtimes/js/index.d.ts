...
export declare function getBuildFunction({ config, errorExit, func, projectRoot, }: Parameters<GetBuildFunction<JsBuildResult>>[0]): Promise<BuildFunction<JsBuildResult> | (({ cache }: {
