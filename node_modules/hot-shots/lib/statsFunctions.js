...
function applyStatsFns (Client) {
  ...
  Client.prototype.timing = function (stat, time, sampleRate, tags, callback) {
    ...
    debug('timing: stat=%s, time=%s, sampleRate=%s, tags=%j', stat, t, sampleRate, tags);
  ...
  Client.prototype.increment = function (stat, value, sampleRate, tags, callback) {
    ...
    debug('hot-shots increment: stat=%s, value=%s, sampleRate=%s, tags=%j', stat, value, sampleRate, tags);
  ...
  Client.prototype.histogram = function (stat, value, sampleRate, tags, callback) {
    debug('hot-shots histogram: stat=%s, value=%s, sampleRate=%s, tags=%j', stat, value, sampleRate, tags);
  ...
  Client.prototype.distribution = function (stat, value, sampleRate, tags, callback) {
    debug('hot-shots distribution: stat=%s, value=%s, sampleRate=%s, tags=%j', stat, value, sampleRate, tags);
  ...
  Client.prototype.gauge = function (stat, value, sampleRate, tags, callback) {
    debug('hot-shots gauge: stat=%s, value=%s, sampleRate=%s, tags=%j', stat, value, sampleRate, tags);
   ...
   */
    Client.prototype.gaugeDelta = function (stat, value, sampleRate, tags, callback) {
      const sign = value >= 0 ? '+' : '-';
      debug('hot-shots gaugeDelta: stat=%s, value=%s, sampleRate=%s, tags=%j', stat, value, sampleRate, tags);
  ...
  Client.prototype.unique = Client.prototype.set = function (stat, value, sampleRate, tags, callback) {
    debug('hot-shots unique/set: stat=%s, value=%s, sampleRate=%s, tags=%j', stat, value, sampleRate, tags);
