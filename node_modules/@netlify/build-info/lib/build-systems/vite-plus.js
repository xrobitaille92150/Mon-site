...
export class VitePlus extends BaseBuildTool {
    ...
    async detect() {
        ...
        for (const pkgJsonPath of pkgJsonPaths) {
            const pkgJson = await this.project.fs.readJSON(pkgJsonPath);
    ...
    async resolveLockedVersion(pkgJson, pkgJsonPath) {
        ...
        try {
            ...
            const { packages } = await parse(content, typeOrFileName, pkgJson);
...
//# sourceMappingURL=vite-plus.js.map